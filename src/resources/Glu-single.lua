...
local UrlClass = Glu.glass.register({
  ...
  setup = function(___, self)
    ...
    function self.parse(url)
      ...
      local protocol, host, port, path, query_string = rex.match(url,
        "^(https?)://([^/:?]+)(?::(\\d+))?(?:/([^?]*))?(?:\\?(.*))?$")
...
local VersionClass = Glu.glass.register({
  ...
  setup = function(___, self)
    ...
    function self.compare(version1, version2)
      ...
      ___.v.test(type(version1) == "string" or type(version1) == "number", 1,
        "Invalid value to argument 1. Expected a string or number.")
      ___.v.test(type(version2) == "string" or type(version2) == "number", 2,
        "Invalid value to argument 2. Expected a string or number.")
      ...
      ___.v.test(#version1_parts == #version2_parts, 1,
        "Invalid value to arguments. Expected 1 and 2 to have the same number of parts.")
